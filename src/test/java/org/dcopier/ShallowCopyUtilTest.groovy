...
import org.dcopier.util.FinalFieldClass
import org.dcopier.util.SerializableClass
...
class ShallowCopyUtilTest {
    ...
    static Collection<Object[]> data() {
        Collection<Object[]> a = asList(
                ...
                ["Hello"] as Object[],
                ["Test\ntest"] as Object[],
                [new org.dcopier.util.Node(index: 1, name: "node1", next: new org.dcopier.util.Node(index: 2, name: "node2"))] as Object[],
